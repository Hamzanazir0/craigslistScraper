# Working Code From ChatGPT without Pagination
...
class Craigslist:
    file_path = "Data.csv"
    country = "Canada"  # Fixed typo here
    headers = {
    ...
    def categories(self, response, city):
        ...
        with open("input.csv", "r", encoding="utf-8") as input_file:
            ...
            for i in reader:
                category = str(i[0])
                keyword = str(i[1])
                keyword_xpath = "//a[contains(@data-alltitle,'" + category + "')]/@href"
