...
class CraigslistScraperApp:
    def __init__(self, root):
        ...
        self.submit_button = tk.Button(
            root, text="Start Scraper", command=self.start_scraper
        )
    ...
    def start_scraper(self):
        # Get keyword and category from the entries
...
class CraigslistScraper:
    ...
    def add_post_to_google_sheet(self, city_url, category, keyword, post):
        ...
        self.app.log(f"Added new post: {post['title']} - {post['url']}")
